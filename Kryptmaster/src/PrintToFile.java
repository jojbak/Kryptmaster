...
public interface PrintToFile {
	 ...
	 * 
	 * @param String
	 *            path, the path to the directory String out, the output String
	 *            oldFileName, the name of the inputfile
	 */
	void printFile(String path, String out, String oldFileName)
			throws IOException;
